...
Public Class main
    ...
    Public Function verifyRecaptcha() As Boolean
        ...
        'Send WebRequest
		 'TEST KEY
        Dim myRequest As WebRequest = WebRequest.Create("https://www.google.com/recaptcha/api/siteverify?secret=6LeIxAcTAAAAAGG-vFI1TnRWxMZNFuojJ4WifJWe&response=" & strResponse)
